...
_KEYS_WITH_DEFAULTS = {
    ...
    "anthropic_api_key": FD_ANTHROPIC_API_KEY,
    "anthropic_model": FD_ANTHROPIC_MODEL,
    "ai_api_key": FD_AI_API_KEY,
    "ai_base_url": FD_AI_BASE_URL,
    "ai_model": FD_AI_MODEL,
    "ollama_url": FD_OLLAMA_URL,
    "ollama_model": FD_OLLAMA_MODEL,
...
def get_settings(_user: CurrentUser = Depends(_admin)):
    ...
    return AdminSettingsOut(
        ...
        anthropic_api_key_set=bool(values["anthropic_api_key"]),
        anthropic_model=values["anthropic_model"],
        anthropic_configured=bool(values["anthropic_api_key"]),
        ai_api_key_set=bool(values["ai_api_key"]),
        ai_base_url=values["ai_base_url"],
        ai_model=values["ai_model"],
        ai_openai_configured=bool(values["ai_api_key"]),
